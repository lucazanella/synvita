...
exp_name="train_llm_mix_entail_feedback"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch $DISTRIBUTED_ARGS lmms/mPLUG_Owl/pipeline/train.py "$@" ${options} ${multimodal_options} 2>&1 | tee "${SAVE_PATH}/train.log"
